...
arch-chroot /mnt /usr/bin/zsh -c "cd /root mkdir configs2 && cd configs2 && git clone https://gitlab.com/NickTheSecond/configs.git && cd configs/archVM && sh archInstallVM2-chroot.sh"
